...
return new class extends Migration
{
    ...
    {
        if (DB::table('music_tracks')->where('shrine', 'vajrasattva')->exists()) {
            PermanentOfferings::ensureForShrine('vajrasattva');
    ...
    {
        DB::table('music_offerings')->where('shrine', 'vajrasattva')->delete();
        DB::table('flower_offerings')->where('shrine', 'vajrasattva')->delete();
        DB::table('butter_lamps')->where('shrine', 'vajrasattva')->delete();
        DB::table('music_tracks')->where('shrine', 'vajrasattva')->delete();
    }
};
